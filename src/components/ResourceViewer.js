...
//
   ...
   */
      ...
      if(root && root.length) {
         inTitle  = [ 
            <h3 class="inT"><span>{I18n.t("misc.in")}{I18n.t("punc.colon")} </span> {this.uriformat(tmp+"in",root[0])}<Link to={"/show/"+shortUri(root[0].value)+"?part="+this.props.IRI} class="outL"><img src="/scripts/mirador/images/collecR.svg"/>{I18n.t("result.openO")}</Link></h3>,
            //<br/>,
